...
const cableTV = async (req,res) =>{
    ...
    const data = await axios.get(`https://vtu.ng/wp-json/api/v1/tv?username=${username}&password=${password}&phone=${phone}&service_id=${service}&smartcard_number=${smartCard}&variation_id=${variation}`)
